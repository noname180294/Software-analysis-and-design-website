  ...
  return (
    <>
      ...
      <div className="min-vh-100 py-5 container">
          ...
          <div className="modal fade show d-block" tabIndex="-1">
            <div className="modal-dialog modal-lg">
              <div className="modal-content p-4 shadow-lg rounded">
                <h2 className="h4 text-primary text-center mb-4">
                  Apply for <span className="fw-bold">{selectedJob?.title}</span>
                </h2>
                <div className="row g-3">
                  ...
                  <div className="col-md-6">
                    <input className="form-control" placeholder="LinkedIn Profile" />
                  </div>
                  <div className="col-md-6">
                    <input className="form-control" placeholder="GitHub Profile" />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label">Front Side ID Card</label>
                    <input className="form-control" type="file" accept="image/*" />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label">Back Side ID Card</label>
                    <input className="form-control" type="file" accept="image/*" />
                  </div>
                  <div className="col-12">
                  ...
                  <div className="col-12">
                    <textarea className="form-control" placeholder="Talk About Yourself" rows="4"></textarea>
                  </div>
                </div>
                <div className="d-flex justify-content-between mt-4">
                  <button className="btn btn-outline-danger px-4 py-2" onClick={handleClose}>
                    Cancel
                  </button>
                  <button className="btn btn-success px-4 py-2" onClick={handleSubmitCV}>
                    Submit
                  </button>
                </div>
              </div>
        ...
        {submitted && (
          <div className="modal fade show d-block" tabIndex="-1" onClick={() => setSubmitted(false)}>
            <div className="modal-dialog">
              <div className="modal-content p-4 text-center shadow-lg rounded">
                <h3 className="text-success fw-bold">
                  🎉 Your application has been submitted!
                </h3>
                <p className="text-muted">Waiting for a response from the employer.</p>
